...
bp = Blueprint("xhs", __name__, url_prefix="/xhs")
...
def manage():
    ...
    pvcontents = searchPVContentSql(end_date=end_date, plat="小红书")
    if request.method == "POST":
        ...
        pvcontents = searchPVContentSql(end_date=end_date, interval=interval, plat="小红书", group=group, )
    return render_template("html/promotion/promotionXHS.html", selfs=selfs, accounts=accounts, plats=plats,
