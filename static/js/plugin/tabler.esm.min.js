    ...
    return e && Array.prototype.forEach.call(e.length ? e : [e], (function (e) {
        return function (e) {
            if (e && e.nodeName && "TEXTAREA" === e.nodeName && !n.has(e)) {
                var t, i = null, s = null, r = null, a = function () {
                    e.clientWidth !== s && h()
                }, l = function (t) {
            ...
            function c() {
                if (0 !== e.scrollHeight) {
                    ...
                    e.style.height = "", e.style.height = e.scrollHeight + i + "px", s = e.clientWidth, t()
                }
            }
...
var a = l, elements = document.querySelectorAll('[data-bs-toggle="autosize"]');
...
function _objectWithoutProperties(e, t) {
    if (null == e) return {};
    var n, i, s = _objectWithoutPropertiesLoose(e, t);
...
function objectIncludes(e, t) {
    ...
    if (t && e && "object" === _typeof(t) && "object" === _typeof(e)) {
        var r = t instanceof Date, o = e instanceof Date;
        if (r && o) return t.getTime() == e.getTime();
        if (r != o) return !1;
        var a = t instanceof RegExp, l = e instanceof RegExp;
    ...
    return _createClass(e, [{
        ...
        key: "_appendChar", value: function (e) {
            var t, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                r = normalizePrepare(this.doPrepare(e, n)), o = _slicedToArray(r, 2);
            if (e = o[0], (t = (t = o[1]).aggregate(this._appendCharRaw(e, n))).inserted) {
                var a, l = !1 !== this.doValidate(n);
                if (l && null != i) {
                    var u = this.state;
        ...
        key: "append", value: function (e, t, n) {
            ...
            var i = new ChangeDetails, s = isString(n) ? new ContinuousTailDetails(String(n)) : n;
        ...
        key: "splice", value: function (e, t, n, i) {
            var s, r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {input: !0}, o = e + t,
                a = this.extractTail(o);
            this.eager && (i = forceDirection(i), s = this.extractInput(0, o, {raw: !0}));
            var l = this.nearestInputPos(e, t > 1 && 0 !== e && !this.eager ? DIRECTION.NONE : i),
                u = new ChangeDetails({tailShift: l - e}).aggregate(this.remove(l));
            if (this.eager && i !== DIRECTION.NONE && s === this.rawInputValue) if (i === DIRECTION.FORCE_LEFT) for (var c; s === this.rawInputValue && (c = this.value.length);) u.aggregate(new ChangeDetails({tailShift: -1})).aggregate(this.remove(c - 1)); else i === DIRECTION.FORCE_RIGHT && a.unshift();
            return u.aggregate(this.append(n, r, a))
        }
    }, {
        ...
        key: "typedValueEquals", value: function (t) {
            ...
            return t === n || e.EMPTY_VALUES.includes(t) && e.EMPTY_VALUES.includes(n) || this.doFormat(t) === this.doFormat(this.typedValue)
        }
    }]), e
}();
...
}, Masked.EMPTY_VALUES = [void 0, null, ""], IMask.Masked = Masked, IMask.createMask = createMask;
var _excluded$4 = ["mask"], DEFAULT_INPUT_DEFINITIONS = {
    0: /\d/,
    ...
    function e(t) {
        ...
        var n = t.mask, i = _objectWithoutProperties(t, _excluded$4);
        this.masked = createMask({mask: n}), Object.assign(this, i)
    }
    ...
    return _createClass(e, [{
        ...
        key: "nearestInputPos", value: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : DIRECTION.NONE, n = 0,
    ...
    return _createClass(e, [{
        ...
        key: "_appendChar", value: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = new ChangeDetails;
            if (this._value) return n;
            var i = this.char === e,
                s = i && (this.isUnmasking || t.input || t.raw) && (!t.raw || !this.eager) && !t.tail;
...
}(), _excluded$3 = ["chunks"], ChunksTailDetails = function () {
    function e() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
            n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
    ...
    return _createClass(e, [{
        ...
        key: "appendTo", value: function (t) {
            ...
            for (var n = new ChangeDetails, i = 0; i < this.chunks.length && !n.skip; ++i) {
                var s = this.chunks[i], r = t._mapPosToBlock(t.value.length), o = s.stop, a = void 0;
        ...
        key: "state", get: function () {
            ...
            var n = t.chunks, i = _objectWithoutProperties(t, _excluded$3);
    ...
    function e(t, n) {
        ...
        var i = t._mapPosToBlock(n) || (n < 0 ? {index: 0, offset: 0} : {index: this.masked._blocks.length, offset: 0}),
...
var _excluded$2 = ["_blocks"], MaskedPattern = function (e) {
    _inherits(n, Masked);
    var t = _createSuper(n);
    ...
    return _createClass(n, [{
        ...
        key: "_rebuildMask", value: function () {
            ...
            if (i && t) for (var s = !1, r = !1, o = 0; o < i.length; ++o) {
                ...
                if (l !== n.STOP_CHAR) if ("{" !== l && "}" !== l) if ("[" !== l && "]" !== l) {
                    ...
                    var c = u ? new PatternInputDefinition({
                        parent: this,
                        lazy: this.lazy,
                        eager: this.eager,
                        ...
                        mask: t[l],
                        isOptional: r
                    }) : new PatternFixedDefinition({char: l, eager: this.eager, isUnmasking: s});
                    this._blocks.push(c)
        ...
        key: "state", get: function () {
            ...
            var t = e._blocks, i = _objectWithoutProperties(e, _excluded$2);
        ...
        key: "_appendCharRaw", value: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                n = this._mapPosToBlock(this.value.length), i = new ChangeDetails;
            if (!n) return i;
            for (var s = n.index; ; ++s) {
                var r, o, a = this._blocks[s];
                if (!a) break;
                var l = a._appendChar(e, Object.assign({}, t, {_beforeTailState: null === (r = t._beforeTailState) || void 0 === r || null === (o = r._blocks) || void 0 === o ? void 0 : o[s]})),
                    u = l.skip;
        ...
        key: "_appendPlaceholder", value: function (e) {
            var t = this, n = new ChangeDetails;
            if (this.lazy && null == e) return n;
            var i = this._mapPosToBlock(this.value.length);
            if (!i) return n;
            var s = i.index, r = null != e ? e : this._blocks.length;
        ...
        key: "_forEachBlocksInRange", value: function (e) {
            ...
            if (i) {
                var s = this._mapPosToBlock(t), r = s && i.index === s.index, o = i.offset,
...
var MaskedRange = function (e) {
    ...
    return _createClass(n, [{
        ...
        key: "boundaries", value: function (e) {
            var t = "", n = "", i = _slicedToArray(e.match(/^(\D*)(\d*)(\D*)/) || [], 3), s = i[1], r = i[2];
        ...
        key: "doPrepare", value: function (e) {
            ...
            var o = String(this.from).padStart(this.maxLength, "0"), a = String(this.to).padStart(this.maxLength, "0"),
                l = this.value + e;
            if (l.length > this.maxLength) return "";
            var u = this.boundaries(l), c = _slicedToArray(u, 2), h = c[0], d = c[1];
...
MaskedDate.DEFAULTS = {
    pattern: "d{.}`m{.}`Y", format: function (e) {
        ...
        var t = _slicedToArray(e.split("."), 3), n = t[0], i = t[1], s = t[2];
...
var _excluded$1 = ["mask"], InputMask = function () {
    function e(t, n) {
    ...
    return _createClass(e, [{
        ...
        key: "updateControl", value: function () {
            var e = this.masked.unmaskedValue, t = this.masked.value, n = this.unmaskedValue !== e || this.value !== t;
            this._unmaskedValue = e, this._value = t, this.el.value !== t && (this.el.value = t), n && this._fireChangeEvents()
        }
    }, {
        key: "updateOptions", value: function (e) {
            var t = e.mask, n = _objectWithoutProperties(e, _excluded$1), i = !this.maskEquals(t),
        ...
        key: "_onInput", value: function (e) {
            ...
            var t = new ActionDetails(this.el.value, this.cursorPos, this.value, this._selection),
                ...
                i = this.masked.splice(t.startChangePos, t.removed.length, t.inserted, t.removeDirection, {
                    input: !0,
                    raw: !0
                }).offset, s = n === this.masked.rawInputValue ? t.removeDirection : DIRECTION.NONE,
    ...
    return _createClass(n, [{
        ...
        key: "doPrepare", value: function (e) {
            ...
            var a = normalizePrepare((t = _get(_getPrototypeOf(n.prototype), "doPrepare", this)).call.apply(t, [this, i].concat(r))),
                l = _slicedToArray(a, 2), u = l[0], c = l[1];
        ...
        key: "_findSeparatorAround", value: function (e) {
            if (this.thousandsSeparator) {
                var t = e - this.thousandsSeparator.length + 1, n = this.value.indexOf(this.thousandsSeparator, t);
                if (n <= e) return n
            }
            return -1
        }
        ...
        key: "remove", value: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
                n = this._adjustRangeWithSeparators(e, t), i = _slicedToArray(n, 2);
            e = i[0], t = i[1];
            var s = this.value.slice(0, e), r = this.value.slice(t), o = this._separatorsCount(s.length);
            this._value = this._insertThousandsSeparators(this._removeThousandsSeparators(s + r));
            var a = this._separatorsCountFromSlice(s);
            return new ChangeDetails({tailShift: (a - o) * this.thousandsSeparator.length})
        }
    }, {
        key: "nearestInputPos", value: function (e, t) {
        ...
        key: "typedValueEquals", value: function (e) {
            return (_get(_getPrototypeOf(n.prototype), "typedValueEquals", this).call(this, e) || n.EMPTY_VALUES.includes(e) && n.EMPTY_VALUES.includes(this.typedValue)) && !(0 === e && "" === this.value)
        }
    }]), n
}();
...
}, MaskedNumber.EMPTY_VALUES = [].concat(_toConsumableArray(Masked.EMPTY_VALUES), [0]), IMask.MaskedNumber = MaskedNumber;
...
var _excluded = ["compiledMasks", "currentMaskRef", "currentMask"], MaskedDynamic = function (e) {
    _inherits(n, Masked);
    var t = _createSuper(n);
    ...
    return _createClass(n, [{
        ...
        key: "_appendCharRaw", value: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = this._applyDispatch(e, t);
        ...
        key: "_applyDispatch", value: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                ...
                s = t.tail && null != t._beforeTailState ? t._beforeTailState._rawInputValue : i, r = i.slice(s.length),
                o = this.currentMask, a = new ChangeDetails, l = null == o ? void 0 : o.state;
        ...
        key: "currentMaskFlags", value: function (e) {
            var t, n;
            return Object.assign({}, e, {_beforeTailState: (null === (t = e._beforeTailState) || void 0 === t ? void 0 : t.currentMaskRef) === this.currentMask && (null === (n = e._beforeTailState) || void 0 === n ? void 0 : n.currentMask) || e._beforeTailState})
        }
    }, {
        ...
        key: "doValidate", value: function (e) {
            return _get(_getPrototypeOf(n.prototype), "doValidate", this).call(this, e) && (!this.currentMask || this.currentMask.doValidate(this.currentMaskFlags(e)))
        }
    }, {
        key: "doPrepare", value: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                i = normalizePrepare(_get(_getPrototypeOf(n.prototype), "doPrepare", this).call(this, e, t)),
                s = _slicedToArray(i, 2), r = s[0], o = s[1];
            if (this.currentMask) {
                var a,
                    l = normalizePrepare(_get(_getPrototypeOf(n.prototype), "doPrepare", this).call(this, r, this.currentMaskFlags(t))),
                    u = _slicedToArray(l, 2);
                r = u[0], a = u[1], o = o.aggregate(a)
            }
            return [r, o]
        }
    }, {
        ...
        key: "state", get: function () {
            ...
            var t = e.compiledMasks, i = e.currentMaskRef, s = e.currentMask,
...
MaskedDynamic.DEFAULTS = {
    dispatch: function (e, t, n) {
        if (t.compiledMasks.length) {
            var i = t.rawInputValue, s = t.compiledMasks.map((function (s, r) {
                return s.reset(), s.append(i, {raw: !0}), s.append(e, t.currentMaskFlags(n)), {
...
var PIPE_TYPE = {MASKED: "value", UNMASKED: "unmaskedValue", TYPED: "typedValue"};

function createPipe(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : PIPE_TYPE.MASKED,
        n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : PIPE_TYPE.MASKED, i = createMask(e);
    return function (e) {
...
function getBoundingClientRect(e, t, n) {
    ...
    var i = e.getBoundingClientRect(), s = 1, r = 1;
    t && isHTMLElement(e) && (s = e.offsetWidth > 0 && round(i.width) / e.offsetWidth || 1, r = e.offsetHeight > 0 && round(i.height) / e.offsetHeight || 1);
    var o = (isElement$1(e) ? getWindow(e) : window).visualViewport, a = !isLayoutViewport() && n,
        l = (i.left + (a && o ? o.offsetLeft : 0)) / s, u = (i.top + (a && o ? o.offsetTop : 0)) / r, c = i.width / s,
        h = i.height / r;
...
var toPaddingObject = function (e, t) {
    return mergePaddingObject("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, t.rects, {placement: t.placement})) : e) ? e : expandToHashMap(e, basePlacements))
};

function arrow(e) {
    var t, n = e.state, i = e.name, s = e.options, r = n.elements.arrow, o = n.modifiersData.popperOffsets,
        a = getBasePlacement(n.placement), l = getMainAxisFromPlacement(a),
        u = [left, right].indexOf(a) >= 0 ? "height" : "width";
    if (r && o) {
        var c = toPaddingObject(s.padding, n), h = getLayoutRect(r), d = "y" === l ? top : left,
            p = "y" === l ? bottom : right, f = n.rects.reference[u] + n.rects.reference[l] - o[l] - n.rects.popper[u],
            g = o[l] - n.rects.reference[l], _ = getOffsetParent(r),
            E = _ ? "y" === l ? _.clientHeight || 0 : _.clientWidth || 0 : 0, m = f / 2 - g / 2, v = c[d],
            y = E - h[u] - c[p], T = E / 2 - h[u] / 2 + m, b = within(v, T, y), A = l;
...
function roundOffsetsByDPR(e) {
    ...
    return {x: round(t * i) / i || 0, y: round(n * i) / i || 0}
}

function mapToStyles(e) {
    var t, n = e.popper, i = e.popperRect, s = e.placement, r = e.variation, o = e.offsets, a = e.position,
        l = e.gpuAcceleration, u = e.adaptive, c = e.roundOffsets, h = e.isFixed, d = o.x, p = void 0 === d ? 0 : d,
        f = o.y, g = void 0 === f ? 0 : f, _ = "function" == typeof c ? c({x: p, y: g}) : {x: p, y: g};
    p = _.x, g = _.y;
    var E = o.hasOwnProperty("x"), m = o.hasOwnProperty("y"), v = left, y = top, T = window;
    if (u) {
        var b = getOffsetParent(n), A = "clientHeight", C = "clientWidth";
    ...
    var k, S = Object.assign({position: a}, u && unsetSides),
        O = !0 === c ? roundOffsetsByDPR({x: p, y: g}) : {x: p, y: g};
    return p = O.x, g = O.y, l ? Object.assign({}, S, ((k = {})[y] = m ? "0" : "", k[v] = E ? "0" : "", k.transform = (T.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + g + "px)" : "translate3d(" + p + "px, " + g + "px, 0)", k)) : Object.assign({}, S, ((t = {})[y] = m ? g + "px" : "", t[v] = E ? p + "px" : "", t.transform = "", t))
}

function computeStyles(e) {
    var t = e.state, n = e.options, i = n.gpuAcceleration, s = void 0 === i || i, r = n.adaptive, o = void 0 === r || r,
        a = n.roundOffsets, l = void 0 === a || a, u = {
...
function effect(e) {
    var t = e.state, n = e.instance, i = e.options, s = i.scroll, r = void 0 === s || s, o = i.resize,
        a = void 0 === o || o, l = getWindow(t.elements.popper),
...
function getViewportRect(e, t) {
    var n = getWindow(e), i = getDocumentElement(e), s = n.visualViewport, r = i.clientWidth, o = i.clientHeight, a = 0,
        l = 0;
    if (s) {
    ...
    return {width: r, height: o, x: a + getWindowScrollBarX(e), y: l}
}

function getDocumentRect(e) {
    var t, n = getDocumentElement(e), i = getWindowScroll(e), s = null == (t = e.ownerDocument) ? void 0 : t.body,
        ...
        a = -i.scrollLeft + getWindowScrollBarX(e), l = -i.scrollTop;
...
function isScrollParent(e) {
    var t = getComputedStyle$1(e), n = t.overflow, i = t.overflowX, s = t.overflowY;
...
function listScrollParents(e, t) {
    var n;
    void 0 === t && (t = []);
    var i = getScrollParent(e), s = i === (null == (n = e.ownerDocument) ? void 0 : n.body), r = getWindow(i),
        o = s ? [r].concat(r.visualViewport || [], isScrollParent(i) ? i : []) : i, a = t.concat(o);
...
function getClippingRect(e, t, n, i) {
    var s = "clippingParents" === t ? getClippingParents(e) : [].concat(t), r = [].concat(s, [n]), o = r[0],
...
function computeOffsets(e) {
    var t, n = e.reference, i = e.element, s = e.placement, r = s ? getBasePlacement(s) : null,
        o = s ? getVariation(s) : null, a = n.x + n.width / 2 - i.width / 2, l = n.y + n.height / 2 - i.height / 2;
    switch (r) {
        case top:
...
function detectOverflow(e, t) {
    void 0 === t && (t = {});
    var n = t, i = n.placement, s = void 0 === i ? e.placement : i, r = n.strategy, o = void 0 === r ? e.strategy : r,
        a = n.boundary, l = void 0 === a ? clippingParents : a, u = n.rootBoundary, c = void 0 === u ? viewport : u,
        h = n.elementContext, d = void 0 === h ? popper : h, p = n.altBoundary, f = void 0 !== p && p, g = n.padding,
        _ = void 0 === g ? 0 : g, E = mergePaddingObject("number" != typeof _ ? _ : expandToHashMap(_, basePlacements)),
        m = d === popper ? reference : popper, v = e.rects.popper, y = e.elements[f ? m : d],
        ...
        A = computeOffsets({reference: b, element: v, strategy: "absolute", placement: s}),
        C = rectToClientRect(Object.assign({}, v, A)), k = d === popper ? C : b, S = {
...
function computeAutoPlacement(e, t) {
    void 0 === t && (t = {});
    var n = t, i = n.placement, s = n.boundary, r = n.rootBoundary, o = n.padding, a = n.flipVariations,
        l = n.allowedAutoPlacements, u = void 0 === l ? placements : l, c = getVariation(i),
        h = c ? a ? variationPlacements : variationPlacements.filter((function (e) {
            return getVariation(e) === c
        })) : basePlacements, d = h.filter((function (e) {
...
function flip(e) {
    ...
    if (!t.modifiersData[i]._skip) {
        for (var s = n.mainAxis, r = void 0 === s || s, o = n.altAxis, a = void 0 === o || o, l = n.fallbackPlacements, u = n.padding, c = n.boundary, h = n.rootBoundary, d = n.altBoundary, p = n.flipVariations, f = void 0 === p || p, g = n.allowedAutoPlacements, _ = t.options.placement, E = getBasePlacement(_), m = l || (E === _ || !f ? [getOppositePlacement(_)] : getExpandedFallbackPlacements(_)), v = [_].concat(m).reduce((function (e, n) {
            ...
            var S = v[k], O = getBasePlacement(S), D = getVariation(S) === start, w = [top, bottom].indexOf(O) >= 0,
                N = w ? "width" : "height",
                I = detectOverflow(t, {placement: S, boundary: c, rootBoundary: h, altBoundary: d, padding: u}),
                L = w ? D ? right : left : D ? bottom : top;
            y[N] > T[N] && (L = getOppositePlacement(L));
            var M = getOppositePlacement(L), P = [];
            if (r && P.push(I[O] <= 0), a && P.push(I[L] <= 0, I[M] <= 0), P.every((function (e) {
                return e
            }))) {
                C = S, A = !1;
                break
...
function hide(e) {
    var t = e.state, n = e.name, i = t.rects.reference, s = t.rects.popper, r = t.modifiersData.preventOverflow,
        o = detectOverflow(t, {elementContext: "reference"}), a = detectOverflow(t, {altBoundary: !0}),
        l = getSideOffsets(o, i), u = getSideOffsets(a, s, r), c = isAnySideFullyClipped(l),
...
function distanceAndSkiddingToXY(e, t, n) {
    var i = getBasePlacement(e), s = [left, top].indexOf(i) >= 0 ? -1 : 1,
        r = "function" == typeof n ? n(Object.assign({}, t, {placement: e})) : n, o = r[0], a = r[1];
    return o = o || 0, a = (a || 0) * s, [left, right].indexOf(i) >= 0 ? {x: a, y: o} : {x: o, y: a}
}

function offset(e) {
    var t = e.state, n = e.options, i = e.name, s = n.offset, r = void 0 === s ? [0, 0] : s,
...
function preventOverflow(e) {
    var t = e.state, n = e.options, i = e.name, s = n.mainAxis, r = void 0 === s || s, o = n.altAxis,
        a = void 0 !== o && o, l = n.boundary, u = n.rootBoundary, c = n.altBoundary, h = n.padding, d = n.tether,
        p = void 0 === d || d, f = n.tetherOffset, g = void 0 === f ? 0 : f,
        _ = detectOverflow(t, {boundary: l, rootBoundary: u, padding: h, altBoundary: c}),
        E = getBasePlacement(t.placement), m = getVariation(t.placement), v = !m, y = getMainAxisFromPlacement(E),
        T = getAltAxis(y), b = t.modifiersData.popperOffsets, A = t.rects.reference, C = t.rects.popper,
        k = "function" == typeof g ? g(Object.assign({}, t.rects, {placement: t.placement})) : g,
        S = "number" == typeof k ? {mainAxis: k, altAxis: k} : Object.assign({mainAxis: 0, altAxis: 0}, k),
        O = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, D = {x: 0, y: 0};
    if (b) {
        if (r) {
            var w, N = "y" === y ? top : left, I = "y" === y ? bottom : right, L = "y" === y ? "height" : "width",
                M = b[y], P = M + _[N], R = M - _[I], F = p ? -C[L] / 2 : 0, x = m === start ? A[L] : C[L],
                V = m === start ? -C[L] : -A[L], $ = t.elements.arrow,
                H = p && $ ? getLayoutRect($) : {width: 0, height: 0},
                B = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : getFreshSideObject(),
                j = B[N], W = B[I], U = within(0, A[L], H[L]),
                K = v ? A[L] / 2 - F - U - j - S.mainAxis : x - U - j - S.mainAxis,
                Y = v ? -A[L] / 2 + F + U + W + S.mainAxis : V + U + W + S.mainAxis,
                G = t.elements.arrow && getOffsetParent(t.elements.arrow),
                z = G ? "y" === y ? G.clientTop || 0 : G.clientLeft || 0 : 0,
                q = null != (w = null == O ? void 0 : O[y]) ? w : 0, X = M + Y - q,
                Q = within(p ? min(P, M + K - q - z) : P, M, p ? max(R, X) : R);
            b[y] = Q, D[y] = Q - M
        }
        if (a) {
            var Z, J = "x" === y ? top : left, ee = "x" === y ? bottom : right, te = b[T],
                ne = "y" === T ? "height" : "width", ie = te + _[J], se = te - _[ee],
                re = -1 !== [top, left].indexOf(E), oe = null != (Z = null == O ? void 0 : O[T]) ? Z : 0,
                ae = re ? ie : te - A[ne] - C[ne] - oe + S.altAxis, le = re ? te + A[ne] + C[ne] - oe - S.altAxis : se,
...
function isElementScaled(e) {
    var t = e.getBoundingClientRect(), n = round(t.width) / e.offsetWidth || 1,
...
function getCompositeRect(e, t, n) {
    void 0 === n && (n = !1);
    var i = isHTMLElement(t), s = isHTMLElement(t) && isElementScaled(t), r = getDocumentElement(t),
        o = getBoundingClientRect(e, s, n), a = {scrollLeft: 0, scrollTop: 0}, l = {x: 0, y: 0};
...
function popperGenerator(e) {
    void 0 === e && (e = {});
    var t = e, n = t.defaultModifiers, i = void 0 === n ? [] : n, s = t.defaultOptions,
            ...
            state: s, setOptions: function (n) {
                ...
                return s.orderedModifiers = c.filter((function (e) {
                    ...
                    if ("function" == typeof r) {
                        var a = r({state: s, name: t, instance: l, options: i}), u = function () {
                        };
                        o.push(a || u)
                    }
                })), l.update()
                ...
                if (!a) {
                    ...
                    if (areValidElements(t, n)) {
                        ...
                        for (var i = 0; i < s.orderedModifiers.length; i++) if (!0 !== s.reset) {
                            var r = s.orderedModifiers[i], o = r.fn, u = r.options, c = void 0 === u ? {} : u,
                                h = r.name;
                            "function" == typeof o && (s = o({state: s, options: c, name: h, instance: l}) || s)
                        } else s.reset = !1, i = -1
                    }
                }
...
var createPopper$2 = popperGenerator(),
    ...
    createPopper = popperGenerator({defaultModifiers: defaultModifiers}), Popper = Object.freeze({
        __proto__: null,
...
const MAX_UID = 1e6, MILLISECONDS_MULTIPLIER = 1e3, TRANSITION_END = "transitionend",
    ...
    DOMContentLoadedCallbacks = [], onDOMContentLoaded = e => {
    ...
    }, execute = (e, t = [], n = e) => "function" == typeof e ? e(...t) : n, executeAfterTransition = (e, t, n = !0) => {
        ...
        t.addEventListener(TRANSITION_END, r), setTimeout((() => {
...
function bootstrapDelegationHandler(e, t, n) {
    return function i(s) {
        ...
        for (let {target: o} = s; o && o !== this; o = o.parentNode) for (const a of r) if (a === o) return hydrateObj(s, {delegateTarget: o}), i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(o, [s])
    }
}
...
function addHandler(e, t, n, i, s) {
    ...
    let [r, o, a] = normalizeParameters(t, n, i);
    ...
    const l = getElementEvents(e), u = l[a] || (l[a] = {}), c = findHandler(u, o, r ? n : null);
    if (c) return void (c.oneOff = c.oneOff && s);
    const h = makeEventUid(o, t.replace(namespaceRegex, "")),
...
function removeHandler(e, t, n, i, s) {
    const r = findHandler(t[n], i, s);
    r && (e.removeEventListener(n, r, Boolean(s)), delete t[n][r.uidEvent])
}

function removeNamespacedHandlers(e, t, n, i) {
    const s = t[n] || {};
    for (const [r, o] of Object.entries(s)) r.includes(i) && removeHandler(e, t, n, o.callable, o.delegationSelector)
}
...
const EventHandler = {
    on(e, t, n, i) {
        ...
        if ("string" != typeof t || !e) return;
        const [s, r, o] = normalizeParameters(t, n, i), a = o !== t, l = getElementEvents(e), u = l[o] || {},
            c = t.startsWith(".");
        if (void 0 === r) {
            ...
            for (const [n, i] of Object.entries(u)) {
                ...
                a && !t.includes(s) || removeHandler(e, l, o, i.callable, i.delegationSelector)
            }
        } else {
...
class Config {
    ...
    _typeCheckConfig(e, t = this.constructor.DefaultType) {
        for (const [i, s] of Object.entries(t)) {
            const t = e[i],
                r = isElement(t) ? "element" : null == (n = t) ? `${n}` : Object.prototype.toString.call(n).match(/\s([a-z]+)/i)[1].toLowerCase();
...
const NAME$d = "swipe", EVENT_KEY$9 = ".bs.swipe", EVENT_TOUCHSTART = "touchstart.bs.swipe",
...
class Carousel extends BaseComponent {
    ...
    _slide(e, t = null) {
        ...
        if (s === n) return;
        const r = this._getItemIndex(s), o = t => EventHandler.trigger(this._element, t, {
            relatedTarget: s,
        ...
        const l = i ? CLASS_NAME_START : CLASS_NAME_END, u = i ? CLASS_NAME_NEXT : CLASS_NAME_PREV;
        s.classList.add(u), reflow(s), n.classList.add(l), s.classList.add(l);
        this._queueCallback((() => {
            s.classList.remove(l, u), s.classList.add("active"), n.classList.remove("active", u, l), this._isSliding = !1, o(EVENT_SLID)
...
const NAME$b = "collapse", DATA_KEY$7 = "bs.collapse", EVENT_KEY$7 = ".bs.collapse", DATA_API_KEY$4 = ".data-api",
    ...
    Default$a = {parent: null, toggle: !0}, DefaultType$a = {parent: "(null|element)", toggle: "boolean"};
...
const NAME$8 = "focustrap", DATA_KEY$5 = "bs.focustrap", EVENT_KEY$5 = ".bs.focustrap",
    ...
    TAB_NAV_FORWARD = "forward", TAB_NAV_BACKWARD = "backward", Default$7 = {autofocus: !0, trapElement: null},
...
const NAME$7 = "modal", DATA_KEY$4 = "bs.modal", EVENT_KEY$4 = ".bs.modal", DATA_API_KEY$2 = ".data-api",
    ...
    EVENT_MOUSEDOWN_DISMISS = "mousedown.dismiss.bs.modal", EVENT_KEYDOWN_DISMISS$1 = "keydown.dismiss.bs.modal",
    EVENT_CLICK_DATA_API$2 = "click.bs.modal.data-api", CLASS_NAME_OPEN = "modal-open", CLASS_NAME_FADE$3 = "fade",
    CLASS_NAME_SHOW$4 = "show", CLASS_NAME_STATIC = "modal-static", OPEN_SELECTOR$1 = ".modal.show",
    SELECTOR_DIALOG = ".modal-dialog", SELECTOR_MODAL_BODY = ".modal-body",
    SELECTOR_DATA_TOGGLE$2 = '[data-bs-toggle="modal"]', Default$6 = {backdrop: !0, focus: !0, keyboard: !0},
...
class Modal extends BaseComponent {
    ...
    show(e) {
        ...
        EventHandler.trigger(this._element, EVENT_SHOW$4, {relatedTarget: e}).defaultPrevented || (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add("modal-open"), this._adjustDialog(), this._backdrop.show((() => this._showElement(e))))
    }

    hide() {
        if (!this._isShown || this._isTransitioning) return;
        EventHandler.trigger(this._element, EVENT_HIDE$4).defaultPrevented || (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove("show"), this._queueCallback((() => this._hideModal()), this._element, this._isAnimated()))
    }
...
class Tooltip extends BaseComponent {
    ...
    _createPopper(e) {
        const t = execute(this._config.placement, [this, e, this._element]), n = AttachmentMap[t.toUpperCase()];
    ...
    _setListeners() {
        ...
        for (const t of e) if ("click" === t) EventHandler.on(this._element, this.constructor.eventName("click"), this._config.selector, (e => {
...
const NAME$1 = "tab", DATA_KEY$1 = "bs.tab", EVENT_KEY$1 = ".bs.tab", EVENT_HIDE$1 = "hide.bs.tab",
    ...
    SELECTOR_DROPDOWN_MENU = ".dropdown-menu", NOT_SELECTOR_DROPDOWN_TOGGLE = ":not(.dropdown-toggle)",
    SELECTOR_TAB_PANEL = '.list-group, .nav, [role="tablist"]', SELECTOR_OUTER = ".nav-item, .list-group-item",
